...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2017 at 02:42 PM
...
--
-- Table structure for table `ccientifica`
--
...
--
-- Dumping data for table `ccientifica`
--
...
(2, 'Telma', 'Devolve', 0),
(3, 'Dario', 'Nao', 0),
(4, 'Joana Amaral', 'Esta e a ultima vez..', 0),
(5, 'Silva', 'Concordo', 1),
(6, 'Rui Perreira', 'Bom dia', 1),
(7, 'Silva', 'Ya ya', 0),
(8, 'Sim', 'nnnn', 1),
(9, 'alexandrina', 'boa noite', 0),
(10, 'Yanic', 'Voceeeeee.....eeeee', 0),
(11, 'Ana', 'bbbb', 1),
(12, 'Alfredo', 'Sim', 0),
(13, 'Alfredo', 'Ja Consegui', 0),
(14, 'Enzi', 'Tabula', 0),
(15, 'Enzi', 'sim', 1),
...
--
-- Table structure for table `dircurso`
--
...
--
-- Dumping data for table `dircurso`
--
...
--
-- Table structure for table `docente_has_area`
--
...
--
-- Dumping data for table `docente_has_area`
--
...
(34, 'Fluxo em Redes', 'pendente', '2017-07-27', '2017-09-21', 'Criacao de Algoritmo de Fluxo de Redes', 'Faculdade de Engenharia da Universidade Eduar', 'ISCTEM', NULL, 22, 37, 14),
...
--
-- Constraints for table `dircurso`
--
ALTER TABLE `dircurso`
...
--
-- Constraints for table `docente_has_area`
--
ALTER TABLE `docente_has_area`
...
--
-- Constraints for table `supervisao`
--
ALTER TABLE `supervisao`
